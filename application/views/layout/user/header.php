        ...
        ***********************************-->
        <div class="nav-header">
            <a href="index.html" class="brand-logo">
                <img class="logo-abbr" src="<?= base_url('assets') ?>/draw.svg" width="120" alt="">
                <img class="logo-compact" src="<?= base_url('assets') ?>/draw.svg" alt="">
        ...
        <div class="deznav">
            <div class="deznav-scroll">
                <ul class="metismenu" id="menu">
                    ...
                    <li><a href="<?= site_url('payroll') ?>" class="ai-icon" aria-expanded="false">
                            <i class="flaticon-381-ring"></i>
                            <span class="nav-text">Payroll</span>
                        </a>
                    </li>
                    <li><a href="<?= site_url('payment') ?>" class="ai-icon" aria-expanded="false">
                            <i class="flaticon-381-database"></i>
                            <span class="nav-text">Histori Pembayaran</span>
                        </a>
                    </li>
